...
*/
      ...
      GnomeSorter in1 = new GnomeSorter("measures_10.txt");
      in1.sortMe();
      System.out.println();
      */
      System.out.println("Bogo Sort:");
      InsertionSorter in2 = new InsertionSorter("measures_100.txt");
      in2.sortMe();
      System.out.println();
      /*System.out.println("Brick Sort:");
      BrickSorter in3 = new BrickSorter("measures_10.txt");
      in3.sortMe();
      System.out.println();*/
